...
- (CGLTopFilter *)topFilter {
    if (!_topFilter) {
        _topFilter = [[CGLTopFilter alloc] initWithFrame:CGRectZero height:50 selectItems:@[@{@"类型":@[@"全部",@"住宅",@"别墅",@"写字楼",@"商铺"].mutableCopy}.mutableCopy,@{@"楼盘":@[@"全部",@"绿城百合",@"华润橡树湾",@"齐润花园"].mutableCopy}.mutableCopy].mutableCopy itemParamaters:@[@{CGLButtonAttributeFont:[UIFont systemFontOfSize:14], CGLButtonAttributeButtonBackGroundColor:UIColorMake(0xFFFFFF), CGLButtonAttributeTitle :@"", CGLButtonAttributeTitleColor: UIColorMake(0x394043),CGLButtonAttributeSelectTitleColor: UIColorMake(0x0875E7), CGLButtonAttributeCornerRadius:@(0),CGLButtonAttributeSelectImageName:@"im_search_down",CGLButtonAttributeSpaceBetweenTitleAndImage: @(0)},@{CGLButtonAttributeFont:[UIFont systemFontOfSize:14], CGLButtonAttributeButtonBackGroundColor:UIColorMake(0xFFFFFF), CGLButtonAttributeTitle :@"", CGLButtonAttributeTitleColor: UIColorMake(0x394043),CGLButtonAttributeSelectTitleColor: UIColorMake(0x0875E7), CGLButtonAttributeCornerRadius:@(0),CGLButtonAttributeSelectImageName:@"im_search_down",CGLButtonAttributeSpaceBetweenTitleAndImage: @(0)}] completionHandler:^(NSInteger index, CGLFilterSelectModel *selectedModel) {
            switch (index) {
                case 0:
